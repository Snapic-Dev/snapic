...
return [
    ...
    'routes' => [
        [
            'match' => [
                'prefixes' => ['payment', 'admin/metrics', 'socialAuth', 'influencer'], // Defina os prefixos que você deseja documentar
                'domains' => ['*'],  // Documenta todas as rotas nesses domínios
            ],
            'include' => ['*'], // Inclua todas as rotas correspondentes
            'exclude' => [], // Opcional, se houver rotas que você deseja excluir
        ],
    ],
