  ...
  var PhotoSwipe = function (template, UiClass, items, options) {
    ...
    var _isOpen,
      ...
      _applyZoomTransform = function (styleObj, x, y, zoom, item) {
        // Skipping transform for audio and video files
        if (typeof item !== "undefined") {
          if (
            /\.(mp3|wav)$/i.test(item.src) ||
            /\.(mp4|ogg|webm)$/i.test(item.src)
          ) {
    ...
    var _showOrHideTimeout,
      _showOrHide = function (item, img, out, completeFn) {
        ...
        var startAnimation = function () {
          ...
          let adjustedThumbnailUrl = adjustUrl(self.currItem.src);
          self.currItem.src = adjustedThumbnailUrl;
    ...
    var _getItemAt,
      ...
      _calculateSingleItemPanBounds = function (
        ...
        let adjustedThumbnailUrl = adjustUrl(self.currItem.src);
        items[0].src = adjustedThumbnailUrl;
    ...
    _registerModule("Controller", {
      publicMethods: {
        ...
        setContent: function (holder, index) {
          ...
          var wrapper = framework.createEl("pswp__zoom-wrap");
          var baseDiv = (item.container = wrapper);
