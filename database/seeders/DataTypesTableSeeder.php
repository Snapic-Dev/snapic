    ...
    public function run()
    {
        ...
        DB::table('data_types')->insert(array(
            ...
            array(
                ...
                'name' => 'niches',
                'slug' => 'niches',
                'display_name_singular' => 'Nicho',
                'display_name_plural' => 'Nicho',
                'icon' => 'voyager-sort',
                'model_name' => 'App\Model\Niche',
                'policy_name' => NULL,
                'controller' => NULL,
                'description' => NULL,
                'generate_permissions' => 1,
            ...
            array(
                ...
                'name' => 'gifts',
                'slug' => 'gifts',
                'display_name_singular' => 'Gift',
                'display_name_plural' => 'Gift',
                'icon' => 'voyager-photos',
                'model_name' => 'App\Model\Gift',
                'policy_name' => NULL,
                'controller' => NULL,
                'description' => NULL,
                'generate_permissions' => 1,
