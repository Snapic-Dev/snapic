                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('installer.beginInstall') }}" class="finalInstallStepForm">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <input id="site_title" type="site_title"
                                        class="form-control @error('site_title') is-invalid @enderror" name="site_title"
                                        value="{{ old('site_title') }}" autocomplete="site_title" autofocus>
                                    @error('site_title')
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <input id="app_url" type="app_url"
                                        class="form-control @error('app_url') is-invalid @enderror" name="app_url"
                                        value="{{ old('app_url') ? old('app_url') : (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] ? 'https://' : 'http://') . $_SERVER['HTTP_HOST'] }}"
                                        autocomplete="app_url" autofocus>
                                    <small class="d-flex align-items-center mt-1"> @include('elements.icon', [
                                        'icon' => 'information-circle-outline',
                                        'variant' => 'small',
                                        'centered' => false,
                                    ])
                                        {{ __('Domain url or full installation path') }}</small>
                                    @error('app_url')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="h-pill h-pill-primary ml-2 rounded" data-toggle="tooltip"
                                            ...
                                            onclick="Installer.togglePasswordField();">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <input id="license" type="license"
                                        ...
                                        value="{{ old('license') }}" autocomplete="license" autofocus>
                                    @error('license')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                                    <small>You can grab the code from the envato <a href="https://codecanyon.net/downloads"
                                            rel="nofollow" target="_blank">Downloads</a> area or the purchase email.</small>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <a href="{{ route('installer.install') . '?step=2' }}"
                                    class="">{{ __('Back') }}</a>
