...
@section('scripts')
    {!! Minify::javascript(['/js/Installer.js'])->withFullUrl() !!}
@stop
@section('content')
            ...
            <div class="col-4">
                <div class="d-flex justify-content-center pb-5">
                    <a href="{{ route('installer.savedb') }}">
                        <img class="brand-logo" src="{{ asset('/img/snapic-black.png') }}">
                    </a>
                </div>
                        ...
                        <form method="POST" action="{{ route('installer.savedb') }}">
                            ...
                            <div class="d-flex row">
                                <div class="form-group col-6">
                                    ...
                                    <div class="">
                                        <input id="db_host" placeholder="localhost" type="text"
                                            class="form-control @error('db_host') is-invalid @enderror" name="db_host"
                                            value="{{ old('db_host') ? old('db_host') : (session('db_host') ? session('db_host') : 'localhost') }}"
                                            autocomplete="db_host" autofocus>
                                        @error('db_host')
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="">
                                        <input id="db_port" type="text"
                                            class="form-control @error('db_port') is-invalid @enderror" name="db_port"
                                            value="{{ old('db_port') ? old('db_port') : (session('db_port') ? session('db_port') : '3306') }}"
                                            autocomplete="db_port" autofocus>
                                        @error('db_port')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <input id="db_name" type="text"
                                        ...
                                        value="{{ old('db_name') ? old('db_name') : (session('db_name') ? session('db_name') : '') }}"
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <input id="db_username" type="text"
                                        class="form-control @error('db_username') is-invalid @enderror" name="db_username"
                                        value="{{ old('db_username') ? old('db_username') : (session('db_username') ? session('db_username') : '') }}"
                                        autocomplete="db_username" autofocus>
                                    @error('db_username')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="">
                                    <div class="d-flex">
                                        <input type="password" id="db_password"
                                            ...
                                            autocomplete="db_password" autofocus>
                                        <div class="h-pill h-pill-primary ml-2 rounded" data-toggle="tooltip"
                                            data-placement="top" title="{{ __('Show password') }}"
                                            onclick="Installer.togglePasswordField('db_password');">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <a href="{{ route('installer.install') . '?step=1' }}"
                                    class="">{{ __('Back') }}</a>
