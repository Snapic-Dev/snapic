                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-4 d-flex justify-content-end">
                                <div data-toggle="tooltip" data-placement="top"
                                    title="{{ __('FFMpeg paths are configured in admin panel. If not available, videos formats will fallback to mp4, uncompressed videos.') }}">
                                    @include('elements.icon', [
                        ...
                        <div class="d-flex flex-row-reverse">
                            @if ($passesRequirements)
                                <a href="{{ route('installer.install') . '?step=2' }}"
                                    class="btn btn-primary mt-4">{{ __('Next') }}</a>
                            @else
