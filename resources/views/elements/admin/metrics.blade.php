        ...
        <div class="parent">
            <div class="div1">
                <div id="metric1" class="cardMetric no-blur-effect">
                    ...
                    <p class="dashCardMetric">{{\App\Providers\DashboardServiceProvider::getLast24HoursRegisteredUsersCount()}}</p>
            ...
            <div class="div2">
                <div id="metric2" class="cardMetric no-blur-effect">
                    ...
                    <p class="dashCardMetric">{{\App\Providers\DashboardServiceProvider::getActiveSubscriptionsCount()}}</p>
            ...
            <!-- <div class="mb-4 col-md-4">
                ...
                <div class="card shadow rounded p-5">
                    <div class="card-body text-muted font-weight-medium">
                        ...
                        <p>{{__("Post
                             comments")}}: {{\App\Providers\DashboardServiceProvider::getPostCommentsCount()}}</p>
            ...
            <div class="div4">
                <div id="metric4" class="cardMetric no-blur-effect">
                    ...
                    <!-- <p>{{__("Active subscriptions")}}: {{\App\Providers\DashboardServiceProvider::getActiveSubscriptionsCount()}}</p>
                        <p>{{__("Subscriptions revenue")}}: {{\App\Providers\SettingsServiceProvider::getWebsiteFormattedAmount(\App\Providers\DashboardServiceProvider::getTotalSubscriptionsRevenue())}}</p>
                        <p>{{__("Total transactions")}}: {{\App\Providers\DashboardServiceProvider::getTotalTransactionsCount()}}</p> -->
                    <p class="dashCardMetric">{{\App\Providers\SettingsServiceProvider::getWebsiteFormattedAmount(\App\Providers\DashboardServiceProvider::getTotalEarned())}}</p>
                ...
                <table class="RankingTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-totalEarned">R$ {{ number_format($influencer->total_earned, 2, ',', '.') }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
