                    ...
                    <div class="pr-2">
                        <div class="m-0 h6 text-truncate d-flex  align-items-center">
                            <a href="{{ route('profile', ['username' => $profile->username]) }}"
                                class="text-bold text-{{ Cookie::get('app_theme') == null ? (getSetting('site.default_user_theme') == 'dark' ? 'white' : 'dark') : (Cookie::get('app_theme') == 'dark' ? 'white' : 'dark') }} mr-2 d-flex align-items-center">
                                {{ $profile->name }}
                            </a>
                        </div>
                        <div class="m-0 text-truncate small"><a
                                href="{{ route('profile', ['username' => $profile->username]) }}"
                                class="text-muted">&commat;{{ $profile->username }}</a></div>
                    </div>
                </div>
            </div>
        </div>
