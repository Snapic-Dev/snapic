    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title p-2">{{__('Add user to list')}}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p class="p-2">{{__('Chose the list you want to add the user into')}}</p>
                <div class="add-user-lists-wrapper p-2">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-white btn-round"  data-dismiss="modal">{{__('Close')}}</button>
            </div>
        </div>
    </div>
</div>
