<div class="stream-details mb-2 d-flex justify-content-between">
    <div class="mr-4 overflow-hidden">
        ...
        <div class="d-flex flex-row my-1">
            <div class="d-flex justify-content-center">
                <img class="rounded-circle rounded-circle-stream avatar" src="{{$stream->user->avatar}}" alt="{{$stream->user->username}}">
            </div>
            <div class="pl-3 w-100 d-flex align-items-center">
                <div>
                    ...
                    <span class="text-muted">{{__("Started streaming")}} {{\Carbon\Carbon::parse($stream->created_at)->diffForhumans()}}.</span>
                    @else
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="d-none d-sm-block">
            <div class="watchingUsersPill ml-2 pointer-cursor" href="{{route('my.streams.get')}}?action=details" title="Assistindo">
