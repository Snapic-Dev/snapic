    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title p-3"><span class="create-label d-none">{{ __('Start a new stream') }}</span> <span
            ...
            <div class="modal-body">
                <div class="form-group p-3">
                    ...
                    <input class="form-control" id="stream-name" name="stream-name" aria-describedby="name"
                        value="{{ $activeStream ? $activeStream->name : '' }}">
                ...
                <div class="form-group p-3">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" id="stream-access_price" name="access_price"
                            aria-describedby="access_price" value="{{ $activeStream ? $activeStream->price : '' }}"
                            type="number">
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group p-3">
                    ...
                    <div class="card profile-cover-bg"
                        style="background-image: url('{{ $activeStream && $activeStream->poster ? $activeStream->poster : asset('/img/live-stream-cover.svg') }}');">
                ...
                <div class="p-3">
                    <div class="custom-control custom-switch">
                        ...
                        <label class="custom-control-label"
                            for="requires_subscription">{{ __('Requires a subscription') }}</label>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-round btn-primary stream-save-btn"
                    onclick="Streams.updateStream();">{{ __('Save') }}</button>
            </div>
        </div>
    </div>
</div>
