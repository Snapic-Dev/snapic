...
<div>
    <div class="payment-method p-2">
        <div class="custom-control custom-radio mb-1">
            <input type="radio" id="pixRadio" name="payment-radio-option" class="custom-control-input"
                value="pix">
            <label class="custom-control-label stepTooltip text-bold" for="pixRadio" title="">Pix</label>
        </div>
        <!-- <div class="custom-control custom-radio mb-1">
        ...
        <div class="mt-4">
            <button type="button" onclick="deposit()"
                ...
                data-target="#staticBackdrop" onclick="showDepositValue()" class="spinner-border spinner-border-sm"
                role="status" aria-hidden="true" disabled>
                ...
                <div class="modal-dialog">
                    <div class="modal-content mt-5">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="form-row p-4">
                                    <div class="col mt-2">
                                        ...
                                        <input maxlength="19" class="form-control cardNumber"
                            ...
                            <button type="button" onclick="deposit()"
                                class="modalCreditCard btnDeposit btn-block btn-round btn border btn-primary p-3"
                                data-target="#staticBackdrop2" class="spinner-border spinner-border-sm"
    ...
    <script>
        ...
        function inputDepositValue() {
            ...
            const minimumDepositAmount = parseFloat(
        ...
        const deposit = async () => {
            ...
            try {
                ...
                if (Number(depositInput.value) < Number(
                        `{{ \App\Providers\PaymentsServiceProvider::getDepositMinimumAmount() }}`)) {
                    throw new Error(
