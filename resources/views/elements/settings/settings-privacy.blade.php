<div class="form-group p-2">
    <!-- <div class="card py-4 px-4">
        ...
        <div class="mt-2">
            ...
            <ul class="mt-1 mb-2">
                ...
                <li>{{ __('It will also be generally hidden from suggestions and user searches on our platform.') }}
                </li>
            </ul>
        </div>
    </div> -->
    ...
    @if (getSetting('profiles.allow_users_enabling_open_profiles'))
        <div class="card py-4 px-4 mt-4">
            <div class="custom-control custom-switch custom-switch">
                <input type="checkbox" class="custom-control-input" id="open_profile"
    ...
    @if (getSetting('security.allow_geo_blocking'))
        <div class="mb-3 card mt-3">
                ...
                <div class="custom-control custom-switch custom-switch">
                    <div class="ml-3">
                        ...
                        <label class="custom-control-label"
                            for="enable_geoblocking">{{ __('Enable Geo-blocking') }}</label>
                    </div>
                    <div class="ml-3 mt-2">
                        <small
                            class="fa-details-label">{{ __('If enabled, visitors from certain countries will be restricted access.') }}</small>
                    </div>
                </div>
            </div>
            <div class="form-group px-2 mx-3 mt-2">
                ...
                <select class="country-select form-control input-sm uifield-country" id="countrySelect" required
                    multiple="multiple">
    ...
    @if (getSetting('security.allow_users_2fa_switch'))
        <div class="mb-3 card py-4 px-4 mt-3">
            ...
            <div class="custom-control custom-switch custom-switch">
                ...
                <div class="ml-3 mt-2">
                    <small
                        class="fa-details-label">{{ __('If enabled, access from new devices will be restricted until verified.') }}</small>
                </div>
            </div>
