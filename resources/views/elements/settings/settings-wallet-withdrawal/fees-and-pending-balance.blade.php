<div class="d-flex justify-content-between align-items-center mt-3">
    ...
    <div class="d-flex align-items-center">
        <span class="text-right p-3 textWithdrawal" id="pending-balance" title="{{__("The payouts are manually and it usually take up to 24 hours for a withdrawal to be processed, we will notify you as soon as your request is processed.")}}">
