...
<form method="POST" action="{{ route('my.settings.rates.save') }}">
    ...
    <div
        ...
        <div class="form-group p-2">
            ...
            <div class="input-group mb-3">
                <input class="form-control {{ $errors->has('profile_access_price_3_months') ? 'is-invalid' : '' }}"
        ...
        <div class="form-group p-2">
            ...
            <div class="input-group mb-3">
                <input class="form-control {{ $errors->has('profile_access_price_6_months') ? 'is-invalid' : '' }}"
        ...
        <div class="form-group p-2">
            ...
            <div class="input-group mb-3">
                <input class="form-control {{ $errors->has('profile_access_price_12_months') ? 'is-invalid' : '' }}"
        ...
        @if (!getSetting('profiles.disable_profile_offers'))
            <div class="form-group p-2">
                ...
                <div class="input-group-prepend">
                    ...
                    <input type="date"
                        class="form-control {{ $errors->has('profile_access_offer_date') ? 'is-invalid' : '' }}"
