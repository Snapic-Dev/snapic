<div class="row checkout-dialog">
    <div class="col-lg-6 mx-auto">
        ...
        <div class="checkout-popup modal fade" id="checkout-center" tabindex="-1" role="dialog"
            aria-labelledby="checkout" aria-hidden="false">
                                                ...
                                                <div id="individual" class="tab-pane fade show active pt-1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="2" type="text" name="billingAddress" onblur="checkout.validateBillingAddressField()"
                                                            ...
                                                            class="form-control w-100 uifield-billing_address" required></textarea>
                                                    </div>
                                                </div>
                        ...
                        <div>
                            ...
                            <div class="d-flex text-left radio-group row px-2">
                                ...
                                @if (getSetting('payments.nowpayments_api_key') && !getSetting('payments.nowpayments_checkout_disabled'))
                                    <div
                                        class="p-1 col-6 col-md-3 col-lg-3 col-md-3 d-none nowpayments-payment-method">
                                ...
                                @if (\App\Providers\PaymentsServiceProvider::ccbillCredentialsProvided())
                                    <div class="p-1 col-6 col-md-3 col-lg-3 col-md-3 d-none ccbill-payment-method">
                                        <div class="radio mx-auto ccbill-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center"
                                            data-value="ccbill">
                                ...
                                @if (getSetting('payments.paystack_secret_key') && !getSetting('payments.paystack_checkout_disabled'))
                                    <div class="p-1 col-6 col-md-3 col-lg-3 col-md-3 d-none paystack-payment-method">
                                        <div class="radio mx-auto paystack-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center"
                                            data-value="paystack">
                                ...
                                @endif
                                <div class="credit-payment-method p-1 col-6 col-md-3 col-lg-3 col-md-3"
                                    {!! !Auth::check() || Auth::user()->wallet->total <= 0 ? 'data-toggle="tooltip" data-placement="right"' : '' !!}
                                    title="{{ __('You can use the wallet deposit page to add credit.') }}">
                                    <div class="radio mx-auto credit-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center selected"
                                        data-value="credit">
