    ...
    <div class="kind-of-a-form-control">
        ...
        <div class="panel-body no-padding-left-right setting-row" data-settingkey="license_product_license_key">
            <div class="col-md-12 no-padding-left-right">
                <input type="text" class="form-control license_product_license_key" name="license_product_license_key"
                    placeholder="Your license key"
                    value="{{ getSetting('license.product_license_key') ? getSetting('license.product_license_key') : '' }}">
            </div>
        </div>
        <div class="admin-setting-description">
            <code>
                Your product license key. Can be taken out of your <a href="https://codecanyon.net/downloads">Codecanyon
                    downloads</a> page.
            </code>
        </div>
