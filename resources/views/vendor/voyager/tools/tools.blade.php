                        ...
                        @foreach ($settings as $group => $setting)
                            @if ($group != 'Colors' && $group != 'License')
                                <li @if ($group == $active) class="active" @endif>
                                    <a data-toggle="tab" class="settings-menu-{{ lcfirst($group) }}"
                        ...
                        @foreach ($settings as $group => $group_settings)
                            <div id="{{ \Illuminate\Support\Str::slug($group) }}"
                                        ...
                                        <div class="emails-info">
                                            <div class="alert alert-info alert-dismissible mb-1">
                                                ...
                                                <div class="info-label mb-0">
                                                    <div class="icon voyager-info-circled"></div> You can use any SMTP you
                                                    have access to or mailgun API. Full info can be found over <a
                                            ...
                                            @if (getSetting('storage.driver') == 'public')
                                                <div class="alert alert-warning alert-dismissible mb-1">
                                                    ...
                                                    <div class="info-label mb-0">
                                                        ...
                                                        {{ __('Coconut transcoding can only be used with a remote storage option. Local storage is not supported.') }}
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            @if (!getSetting('websockets.pusher_app_id') && !getSetting('websockets.soketi_host_address'))
                                                <div class="alert alert-warning alert-dismissible mb-1">
                                                    ...
                                                    <div class="info-label mb-0">
                                                        <div class="icon voyager-info-circled"></div>
                                                        <strong>{{ __('Warning!') }}</strong>
                                                        {{ __('Coconut transcoding requires websockets to be enabled. Please check the configure your Websockets area.') }}
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="tabbable-panel">
                                                    <div class="tabbable-line">
                                                        <ul class="nav nav-tabs ">
                                                            <li class="active">
                                                                <a href="#media-general" data-toggle="tab"
                                                                    onclick="Admin.mediaSettingsSubTabSwitch('general')">
                                                                    General </a>
                                                            </li>
                                                            <li>
                                                                <a href="#media-videos" data-toggle="tab"
                                                                    onclick="Admin.mediaSettingsSubTabSwitch('videos')">
                                                                    Videos </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                ...
                                @if ($group == 'Payments')
                                    <div class="tab-additional-info">
                                        <div class="payments-info">
                                                ...
                                                <div class="alert alert-info alert-dismissible mb-1 payments-info-crons">
                                                    ...
                                                    <div class="mt-05">
                                                        Before setting up the payment processors, please also give the <a
                                                            ...
                                                            href="https://docs.qdev.tech/justfans/#payments">docs
                                                            section</a> a read.
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            <div
                                                class="alert alert-info alert-dismissible mb-1 payments-info-paypal d-none">
                                                <button type="button" class="close" data-dismiss="alert"
                                                    aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <div class="info-label">
                                                    <div class="icon voyager-info-circled"></div> In order to be able to
                                                    receive payment updates from Paypal, please use these webhooks
                                                    endpoints:
                                                </div>
                                                <ul>
                                                ...
                                                <div class="mt-05">
                                                    Before setting up the payment processors, please also give the <a
                                                        class="text-white" target="_blank"
                                                        href="https://docs.qdev.tech/justfans/#payments">docs section</a> a
                                                    read.
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                class="alert alert-info alert-dismissible mb-1 payments-info-stripe d-none">
                                                <button type="button" class="close" data-dismiss="alert"
                                                    aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <div class="info-label">
                                                    <div class="icon voyager-info-circled"></div> In order to be able to
                                                    receive payment updates from Stripe, please use these webhooks
                                                    endpoints:
                                                </div>
                                                <ul>
                                            ...
                                            <div
                                                class="alert alert-info alert-dismissible mb-1 payments-info-coinbase d-none">
                                                <button type="button" class="close" data-dismiss="alert"
                                                    aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <div class="info-label">
                                                    <div class="icon voyager-info-circled"></div> In order to be able to
                                                    receive payment updates from Coinbase, please use these webhooks
                                                    endpoints:
                                                </div>
                                                <ul>
                                            ...
                                            <div
                                                class="alert alert-info alert-dismissible mb-1 payments-info-ccbill d-none">
                                                <button type="button" class="close" data-dismiss="alert"
                                                    aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <div class="info-label">
                                                    <div class="icon voyager-info-circled"></div> In order to use CCBill as
                                                    payment provider you'll need the following endpoints:
                                                    <ul>
                                                        <li>Webhook URL: <code>{{ route('ccBill.payment.update') }}</code>
                                                        </li>
                                                        <li>Approval & Denial URL:
                                                            <code>{{ route('payment.checkCCBillPaymentStatus') }}</code>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                class="alert alert-info alert-dismissible mb-1 payments-info-paystack d-none">
                                                <button type="button" class="close" data-dismiss="alert"
                                                    aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <div class="info-label">
                                                    <div class="icon voyager-info-circled"></div> In order to use Paystack
                                                    as payment provider you'll need the following endpoints:
                                                </div>
                                                <ul>
                                            ...
                                            <div
                                                class="alert alert-info alert-dismissible mb-1 payments-info-mercado d-none">
                                                <button type="button" class="close" data-dismiss="alert"
                                                    aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <div class="info-label">
                                                    <div class="icon voyager-info-circled"></div> In order to use Mercado
                                                    as payment provider you'll need the following endpoint:
                                                </div>
                                                <ul>
                                                    <li>Webhook URL: <code>{{ route('mercado.payment.update') }}</code>
                                                    </li>
                                                </ul>
                                            </div>

                                            <div
                                                class="alert alert-info alert-dismissible mb-1 payments-info-nowpayments d-none">
                                                <button type="button" class="close" data-dismiss="alert"
                                                    aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <div class="info-label">
                                                    <div class="icon voyager-info-circled"></div> In order to use
                                                    NowPayments as payment provider you'll need the following endpoint:
                                                </div>
                                                <ul>
                                                    <li>IPN Callback URL:
                                            ...
                                            <div
                                                class="alert alert-info alert-dismissible mb-1 payments-info-stripeConnect d-none">
                                                <button type="button" class="close" data-dismiss="alert"
                                                    aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <div class="info-label">
                                                    <div class="icon voyager-info-circled"></div> In order to use
                                                    StripeConnect as payment option for withdrawals you'll need the
                                                    following endpoint:
                                                </div>
                                                <ul>
                                                    <li>Webhook URL:
                                    ...
                                    <div class="panel-heading setting-row setting-payments.driver"
                                        data-settingkey="payments.driver">
                                        <h3 class="panel-title"> Payment processor </h3>
                                    </div>
                                    <div class="panel-body no-padding-left-right setting-row setting-payments.driver"
                                        data-settingkey="payments.driver">
                                ...
                                @foreach ($group_settings as $setting)
                                    <div class="panel-heading setting-row setting-{{ $setting->key }}"
                                        data-settingkey={{ $setting->key }}>
                                        <h3 class="panel-title">
                                            {{ $setting->display_name }} @if (config('voyager.show_dev_tips'))
                                                <code>getSetting('{{ $setting->key }}')</code>
                                            @endif
                                        </h3>
                                    </div>

                                    <div class="panel-body no-padding-left-right setting-row setting-{{ $setting->key }}"
                                        data-settingkey={{ $setting->key }}>
                                        <div class="col-md-12 no-padding-left-right">
                                    ...
                                    ?>
                                    @if ($hasDescription)
                                        <div class="admin-setting-description setting-row setting-{{ $setting->key }}"
                                            data-settingkey={{ $setting->key }}>
                                            <code>
                                    ...
                                    @endif
                                    @if (!$loop->last)
                                        <hr class="setting-row setting-{{ $setting->key }}"
                                            data-settingkey={{ $setting->key }}>
                                    @endif
                                @endforeach
                            </div>
