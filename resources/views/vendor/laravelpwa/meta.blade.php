...
{{--Iphone 12/13 + pro max + mini covered above --}}
<link href="{{ $config['splash']['1170x2532'] }}" media="(device-width: 390px) and (device-height: 844px) and (-webkit-device-pixel-ratio: 3)" rel="apple-touch-startup-image" />
<link href="{{ $config['splash']['1284x2778'] }}" media="(device-width: 428px) and (device-height: 926px) and (-webkit-device-pixel-ratio: 3)" rel="apple-touch-startup-image" />
{{--Iphone 14/15 pro + pro max --}}
<link href="{{ $config['splash']['1179x2556'] }}" media="(device-width: 393px) and (device-height: 852px) and (-webkit-device-pixel-ratio: 3)" rel="apple-touch-startup-image" />
<link href="{{ $config['splash']['1290x2796'] }}" media="(device-width: 430px) and (device-height: 932px) and (-webkit-device-pixel-ratio: 3)" rel="apple-touch-startup-image" />
{{--Ipads--}}
