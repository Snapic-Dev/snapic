<form method="POST" action="{{ route('register') }}" id="register-form">
    ...
    <div class="form-group ">
        <label for="age" class=" col-form-label ">{{ __('Data Nascimento') }}</label>
        <div class="">
    ...
    <div class="form-group ">
        ...
        <div class="">
            <input id="file" type="file" class="form-control @error('frontDoc') is-invalid @enderror" name="frontDoc"
                value="{{ old('frontDoc') }}" required autocomplete="file" accept=".jpg, .jpeg, .png .webp">
            @error('frontDoc')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
    ...
    <div class="form-group ">
        ...
        <div class="">
            <input id="file" type="file" class="form-control @error('backDoc') is-invalid @enderror" name="backDoc"
                value="{{ old('backDoc') }}" required autocomplete="file" accept=".jpg, .jpeg, .png .webp">
            </input>
            @error('backDoc')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
    ...
    <div class="form-group ">
        ...
        <div class="">
            <input id="nicho" type="text" class="form-control @error('nicho') is-invalid @enderror" name="nicho"
                value="{{ old('nicho') }}" required autocomplete="text">
            @error('nicho')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
