...
<form method="POST" action="{{ route('register-influencer') }}" id="register-influencer-form">
    ...
    <<<<<<< HEAD <div class="form-group ">
        ...
        <div class="">
            <input id="file" type="file" class="form-control @error('frontDoc') is-invalid @enderror"
            ...
            <div class="form-group ">
                ...
                <div class="">
                    <input id="file" type="file" class="form-control @error('backDoc') is-invalid @enderror"
                        name="backDoc" value="{{ old('backDoc') }}" required autocomplete="file"
                        accept=".jpg, .jpeg, .png .webp">
                    </input>
                    @error('backDoc')
                        <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="form-group">
                            <label for="email"
                                class="col-form-label required-label">{{ __('E-Mail Address') }}</label>
                            <div class="">
                        ...
                        <div class="form-group">
                            <label for="frontDoc"
                                class="col-form-label required-label">{{ __('RG ou CNH- Frente') }}</label>
                            <input id="frontDoc" type="file"
                                class="form-control @error('frontDoc') is-invalid @enderror" name="frontDoc"
                                value="{{ old('frontDoc') }}" required autocomplete="file"
                                accept=".jpg, .jpeg, .png, .webp"
                        ...
                        <div class="form-group">
                            <label for="backDoc"
                                class="col-form-label required-label">{{ __('RG ou CNH- Verso') }}</label>
                            <input id="backDoc" type="file"
                                class="form-control @error('backDoc') is-invalid @enderror" name="backDoc"
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select id="nicho" class="form-control @error('nicho') is-invalid @enderror"
                                    name="nicho" required>
                                    <option value="">{{ __('Selecione um nicho') }}</option>
                                    @foreach ($nichos as $nicho)
                                        <option value="{{ $nicho }}"
                                            {{ old('nicho') == $nicho ? 'selected' : '' }}>
                                            {{ $nicho }}</option>
                                    @endforeach
                                </select>
                                @error('nicho')
                        ...
                        <div class="form-group">
                            <label for="password-confirm"
                                class="col-form-label required-label">{{ __('Confirm Password') }}</label>
                            <div class="">
                            ...
                            <div class="custom-control custom-checkbox">
                                <div class="">
                                    <input class="custom-control-input @error('terms') is-invalid @enderror"
                                        id="tosAgree" type="checkbox" name="terms" value="1"
                        ...
                        <div class="form-group row mb-0">
                            <div class="col">
                                <button type="submit"
                                    class="btn btn-grow btn-lg btn-primary bg-gradient-primary btn-block">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
