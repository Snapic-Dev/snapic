            ...
            <div class="row d-flex flex-row align-items-center h-100">
                <div class="col-12 col-md-6 mt-4 mt-md-0">
                    ...
                    <p class="font-weight-bold mt-3">🚀
                        {{ __('Start your own premium creators platform with our ready to go solution.') }}</p>
                    <div class="mt-4">
                        <a href="{{ route('login') }}"
                            class="btn btn-grow bg-gradient-primary  btn-round mb-0 me-1 mt-2 mt-md-0 ">{{ __('Try for free') }}</a>
                        <a href="{{ route('search.get') }}"
                            class="btn btn-grow btn-link  btn-round mb-0 me-1 mt-2 mt-md-0 ">
                ...
                <div class="col-12 col-md-4 mb-5 mb-md-0">
                    <div class="d-flex justify-content-center">
                        <img src="{{ asset('/img/home-scene-1.svg') }}" class="img-fluid home-box-img"
                            alt="{{ __('Premium & Private content') }}">
                    </div>
                ...
                <div class="col-12 col-md-4 mb-5 mb-md-0">
                    <div class="d-flex justify-content-center">
                        <img src="{{ asset('/img/home-scene-3.svg') }}" class="img-fluid home-box-img"
                            alt="{{ __('Secured assets & Privacy focus') }}">
                    </div>
                    <div class="d-flex justify-content-center mt-4">
                        <div class="col-12 col-md-10 text-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="w-100 h-100 d-flex justify-content-center align-items-center">
                        <div class="pl-4 pl-md-5">
                            ...
                            <div>
                                <a href="{{ Auth::check() ? route('my.settings', ['type' => 'verify']) : route('login') }}"
                                    class="btn bg-gradient-primary btn-grow btn-round mb-0 me-1 mt-2 mt-md-0 p-3">{{ __('Become a creator') }}</a>
                            </div>
        ...
        <div class="container">
            ...
            <div class="d-flex align-items-center justify-content-center">
                <div class="d-flex justify-content-center align-items-center row col">
                    <img src="{{ asset('/img/logos/laravel.svg') }}" class="mx-3 mb-2 grayscale"
                        title="{{ ucfirst(__('laravel')) }}" alt="{{ __('laravel') }}" />
                    <img src="{{ asset('/img/logos/bootstrap.svg') }}" class="mx-3 mb-2 grayscale"
                        title="{{ ucfirst(__('bootstrap')) }}" alt="{{ __('bootstrap') }}" />
                    <img src="{{ asset('/img/logos/jquery.svg') }}" class="mx-3 mb-2 grayscale"
                        title="{{ ucfirst(__('jquery')) }}" alt="{{ __('jquery') }}" />
                    <img src="{{ asset('/img/logos/aws.svg') }}" class="mx-3 mb-2 grayscale"
                        title="{{ ucfirst(__('aws')) }}" alt="{{ __('aws') }}" />
                    <img src="{{ asset('/img/logos/pusher.svg') }}" class="mx-3 mb-2 grayscale"
                        title="{{ ucfirst(__('pusher')) }}" alt="{{ __('pusher') }}" />
                    <img src="{{ asset('/img/logos/stripe.svg') }}" class="mx-3 mb-2 grayscale"
                        title="{{ ucfirst(__('stripe')) }}" alt="{{ __('stripe') }}" />
                    <img src="{{ asset('/img/logos/paypal.svg') }}" class="mx-3 mb-2 grayscale"
                        title="{{ ucfirst(__('paypal')) }}" alt="{{ __('paypal') }}" />
                    <img src="{{ asset('/img/logos/coinbase.svg') }}" class="mx-3 mb-2 grayscale coinbasae-logo"
                        title="{{ ucfirst(__('coinbase')) }}" alt="{{ __('coinbase') }}" />
                    <img src="{{ asset('/img/logos/wasabi.svg') }}" class="mx-3 mb-2 grayscale"
                        title="{{ ucfirst(__('wasabi')) }}" alt="{{ __('wasabi') }}" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-4 my-4 white-section ">
        <div class="container">
            <div class="text-center">
                ...
                <p>{{ __("Don't hesitate to send us a message at") }} - <a
                        href="{{ route('contact') }}">{{ __('Contact') }}</a> </p>
            </div>
        </div>
    </div>
@stop
