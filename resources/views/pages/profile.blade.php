                ...
                <div>
                    @if (!Auth::check() || Auth::user()->id !== $user->id)
                        <div class="d-flex flex-row">
                            @php
                                $followingUser = \App\Providers\ListsHelperServiceProvider::getUserFollowingType(
                                    $user->id,
                                    true,
                                );
                            @endphp
                    ...
                    @else
                        <div class="d-flex flex-row">
                            ...
                            @endif
                            <div>
                                <a class="p-pill ml-2 pointer-cursor" data-toggle="tooltip" data-placement="top"
                                    title="Meus pagamentos" href="/my/settings/payments">
                                    @include('elements.icon', ['icon' => 'wallet-outline'])
                                </a>
                            </div>
                            <div>
                                <span class="p-pill ml-2 pointer-cursor" id="copyLinkBoard" data-toggle="tooltip"
                                    data-placement="top" title="{{ __('Copy profile link') }}" onclick="shareOrCopyLink()">
                                    @include('elements.icon', ['icon' => 'share-social-outline'])
                                </span>
                            </div>
                        </div>
