        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <div class="d-flex flex-row">
                    <button class="p-pill ml-2 pointer-cursor" data-toggle="tooltip" data-placement="top" title="{{__('+ Seguir')}}" onclick="Lists.manageFollowsAction('{{$user->id}}')">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-md-between pb-2 pl-4 pr-4 mb-3 mt-1">
                ...
                <div class="d-flex align-items-center mr-2 text-truncate mb-0 mb-md-0">
                    <div class="text-truncate">
                        <a class="p-0 m-0 text-bold mr-1" href="/my/lists/followers">{{ trans_choice('fans', Auth::user()->fansCount, ['number' => count(ListsHelper::getUserFollowers(Auth::user()->id))]) }}
                        </a>
