                    ...
                    <div class="w-100">
                        ...
                        <div class="d-flex justify-content-between w-100 mb-3 mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input id="frontDoc" type="file" class="@error('frontDoc') is-invalid @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <input id="backDoc" type="file" lass="@error('backDoc') is-invalid @enderror"
                            ...
                            {{--  <div class="">
                                <div class="d-flex align-items-center justify-content-center">
                                    @if (Route::currentRouteName() == 'posts.create')
                                        <div class="">
                                            <a href="#"
                                                class="draft-clear-button mr-3 mr-md-3">{{ __('Limpar') }}</a>
                                        </div>
                                    @endif
                                    @if (!GenericHelper::isUserVerified() && getSetting('site.enforce_user_identity_checks'))
