                    ...
                    <form id="myForm" class="w-100">
                        <div class="form-group p-3">
                            ...
                            <input type="text" class="form-control" name="valor" id="formGroupExampleInput"
                                placeholder="Definir valor do anúncio" required>
                        </div>
                        <div class="form-group p-3">
                        ...
                        <div class="form-group p-3">
                            <label for="frontDoc" class="col-form-label">{{ __('Upload Documento Frente') }}</label>
                        ...
                        <div class="d-flex justify-content-between w-100 mb-3 mt-3">
                            <div class="form-group">
                                <button type="button" onclick="onSubmit()" id="uploadButton"
                                    class="btn btn-primary btn-block btn-round post-create-button mb-0">{{ __('Promover') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
