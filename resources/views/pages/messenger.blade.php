        ...
        <div class="min-vh-100 col-12">
            <div class="container messenger min-vh-100">
                <div class="row min-vh-100">
                    ...
                    <div
                        class="col-9 col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-10 border conversation-wrapper rounded-right p-0 d-flex flex-column min-vh-100 pl-5 pr-5">
                                ...
                                <div class="input-group messageBoxInput-wrapper">
                                    ...
                                    <div class="btn-group dropup">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            data-recipient-id="{{ Auth::user()->id }}"> @endif
                                                    @include('elements.icon', ['icon' => 'cash-outline']) </span>
                                            @endif
                                            <div class="d-flex">
