...
<div class="container messenger min-vh-100">
    <div class="row min-vh-100">
        <div class="col-md-4 col-lg-3 border border-right-0 border-left-0 rounded-left conversations-wrapper min-vh-100 overflow-hidden border-top">
            <div class="d-flex justify-content-center justify-content-md-between pt-3 pr-1 pb-2">
                ...
                <span data-toggle="tooltip" title="" class="pointer-cursor" @if(!count($availableContacts)) data-original-title="{{ trans_choice('Before sending a new message, please subscribe to a creator or follow a free profile.', ['user' => 0]) }}" @else data-original-title="{{ trans_choice('Send a new message', ['user' => 0]) }}" @endif>
        ...
        <div class="col-md-8 col-lg-9 border conversation-wrapper rounded-right p-0 d-flex flex-column min-vh-100 pl-5 pr-5">
