            ...
            <div class="col-12 col-md-7 content-md pr-5">
                <form class="well" role="form" method="post" action="{{route('contact.send')}}">
                    <div class="col">
                        ...
                        <p class="mb-4 p-2">{{__("Don't hesitate to contact us for any matter. We will get back to you asap.")}}</p>
                        ...
                        <div class="form-group p-2">
                            <button class="btn-round  btn-block btn btn-primary " type="submit">{{__("Submit")}}</button>
                        </div>
