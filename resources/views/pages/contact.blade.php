                    ...
                    <form class="well" role="form" method="post" action="{{ route('contact.send') }}">
                        <div class="col">
                            ...
                            <div class="form-group p-2">
                                <input type="email"
                                    class="form-control title-form {{ $errors->has('email') ? 'is-invalid' : '' }}"
                                    value="{{ old('email') }}" name="email" placeholder="{{ __('Email address') }}"
                                    autocomplete="email">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group p-2">
                                <input type="text"
                                    class="form-control title-form {{ $errors->has('subject') ? 'is-invalid' : '' }}"
                                    value="{{ old('subject') }}" name="subject" placeholder="{{ __('Subject') }}">
