<div class="side-menu px-1 px-md-2 px-lg-3">
    <div class="user-details mb-4 d-flex pointer-cursor flex-row-no-rtl">
        ...
        @if (Auth::check())
            <<<<<<< HEAD <div class="d-none d-lg-block overflow-hidden mt-1">
                =======
                <div class="d-none d-lg-block overflow-hidden">
                    >>>>>>> feature/sprint_1_ismael
                    <div class="pl-2 d-flex justify-content-center flex-column overflow-hidden">
                        <div class="ml-2 d-flex flex-column overflow-hidden">
                            ...
                            <<<<<<< HEAD <a class="walletPerfil d-flex flex-row" href="/my/settings/wallet">
        ...
        @if (GenericHelper::isEmailEnforcedAndValidated())
            @if (getSetting('streams.allow_streams'))
                <li class="nav-item-live mt-2 mb-0">
                    <<<<<<< HEAD <a role="button" class="btn btn-block btn-round px-3 p-3 mt-3 border"
                                ...
                                <div class="d-flex justify-content-between align-items-center w-100">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex  align-items-center w-100">
                                            ...
                                            <<<<<<< HEAD <div class="ml-4">{{ __('Go live') }}
                                        </div>
                                        =======
...
@if (!getSetting('site.hide_create_post_menu'))
    @if (GenericHelper::isEmailEnforcedAndValidated())
        <<<<<<< HEAD <li class="nav-item mt-4">
            <a role="button" class="btn btn-round border btn-primary btn-block p-3"
                href="{{ route('posts.create') }}">
                =======
                <li class="nav-item">
                    <a role="button" class="btn btn-round btn-primary btn-block "
                        href="{{ route('posts.create') }}">
                        >>>>>>> feature/sprint_1_ismael
                        <span
